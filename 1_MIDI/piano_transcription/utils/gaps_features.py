...
def pack_gaps_dataset_to_hdf5(args):
    ...
    waveform_hdf5s_dir = os.path.join(workspace, 'hdf5s', 'gaps', 'combined', '2024')
    ...
    for n in range(audios_num):
        ...
        # Assume corresponding audio file is base_name + '.wav' in audio_dir
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_dir', type=str, required=True,
                        help='Directory of Gaps dataset (with audio/ and midi/ subfolders)')
