...
def fretnet_cross_val(sample_rate, hop_length, num_frames, iterations, checkpoints, batch_size, learning_rate, gpu_id,
                      ...
                      estimate_onsets, harmonic_dimension, seed, root_dir):
    ...
    gset_base_dir = os.path.join('/', 'data', 'akshaj', 'MusicAI', 'GuitarSet')

    # Keep all cached data/features here
    gset_cache = os.path.join('..', 'generated', 'data')
    gset_cache_train = os.path.join(gset_cache, 'train')
    ...
    try:
        ...
        for k in range(6):
            ...
            print('Training model...', torch.cuda.is_available(), torch.cuda.current_device())
