...
experiment_dir = "/data/sidbanerjee001/Music-AI/FretNet/generated/experiments/FretNet_GuitarSetPlus_HCQT_X"
add_safe_globals([object])           

# Define the model checkpoints to use for six-fold cross-validation
checkpoints = [2100, 2200, 2300, 2400, 2500]
...
for k in range(5):
    ...
    gset_test = GuitarSet(base_dir=os.path.join('/', 'data', 'akshaj', 'MusicAI', 'GuitarSet'),
                          splits=test_splits,
                          hop_length=hop_length,
